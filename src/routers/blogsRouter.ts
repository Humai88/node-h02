...
blogsRouter.get('/:blogId/posts', applyPostQueryDefaults, [...postQueryValidator], getPostsInBlogController)
...
blogsRouter.post('/:blogId/posts', ...postInBlogValidator, createPostInBlogController)